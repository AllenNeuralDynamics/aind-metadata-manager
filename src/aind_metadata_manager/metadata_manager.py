...
class MetadataManager:
    ...
    def _propagate_pipeline_name(
        ...
        The Processing schema requires that every DataProcess.pipeline_name
        appears in the Processing.pipelines list, so enforcing the settings
        pipeline_name here keeps the emitted metadata self-consistent.
