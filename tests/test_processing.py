...
from aind_metadata_manager.upgrade.processing_upgrade import (
    DataProcessUpgrade,
    ProcessingUpgrade,
)
...
PROCESSING_FILES_PATH = (
    Path(__file__).parent / "resources" / "ephys_processing"
)
PYD_VERSION = re.match(r"(\d+.\d+).\d+", pyd_version).group(1)
...
class TestProcessingUpgrade(unittest.TestCase):
    ...
    def test_upgrades_0_0_1(self):
        ...
        expected_error_message = (
            ...
            f"    For further information visit https://errors.pydantic.dev/{PYD_VERSION}/v/string_type"  # noqa: E501
        )
        ...
        self.assertEqual(
            ephys_preprocessing_process.name, "Ephys preprocessing"
        )
        self.assertEqual(ephys_preprocessing_process.software_version, "0.1.5")
        self.assertEqual(
            ephys_preprocessing_process.code_url,
            "https://github.com/AllenNeuralDynamics/aind-data-transfer",  # noqa: E501
            "0.1.5",
        )
        self.assertEqual(ephys_preprocessing_process.software_version, "0.1.5")
    ...
    def test_upgrades_0_2_1(self):
        ...
        self.assertEqual(
            ephys_preprocessing_process.software_version, "0.16.2"
        )
        self.assertEqual(
            ephys_preprocessing_process.code_url,
            "https://github.com/AllenNeuralDynamics/aind-data-transfer",  # noqa: E501
    ...
    def test_upgrades_0_2_5(self):
        ...
        self.assertEqual(
            ephys_preprocessing_process.software_version, "0.29.3"
        )
        self.assertEqual(
            ephys_preprocessing_process.code_url,
            "https://github.com/AllenNeuralDynamics/aind-data-transfer",  # noqa: E501
    ...
    def test_upgrades_0_3_1(self):
        ...
        self.assertEqual(
            ephys_preprocessing_process.software_version, "0.32.0"
        )
        self.assertEqual(
            ephys_preprocessing_process.code_url,
    ...
    def test_upgrades_current(self):
        ...
        self.assertEqual(
            ephys_preprocessing_process.software_version, "0.1000.0"
        )
...
class TestDataProcessUpgrade(unittest.TestCase):
    ...
    def test_upgrade_from_old_model(self):
        ...
        start_date_time = datetime.datetime.fromisoformat(
            "2023-02-22T18:16:35.919299+00:00"  # noqa: E501
        )
        end_date_time = datetime.datetime.fromisoformat(
            "2023-02-22T18:41:06.929027+00:00"  # noqa: E501
        )
        ...
        upgrader = DataProcessUpgrade(
            old_data_process_dict=old_data_process_dict
        )
        ...
        self.assertEqual(
            new_data_process.output_location, "my-output-location"
        )
        self.assertEqual(
            new_data_process.parameters,
            AindGeneric.model_validate({"param1": "value1"}),
        )
    ...
    def test_upgrade_from_other_with_no_notes(self):
        ...
        processing_path = (
            PROCESSING_FILES_PATH
            / "processing_other_no_notes.json"  # noqa: E501
        )
        ...
        # notes that are None for "Other" data processes are replaced with "missing notes"  # noqa: E501
    ...
    def test_upgrade_from_current_model(self):
        ...
        self.assertEqual(
            new_data_process.parameters, AindGeneric(param1="value1")
        )
